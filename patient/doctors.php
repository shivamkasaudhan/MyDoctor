...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from doctor where docname='$keyword' or docname like '$keyword%' or docname like '%$keyword' or docname like '%$keyword%' or doccity='$keyword' or doccity='$keyword' or doccity like '$keyword%' or doccity like '%$keyword' or doccity like '%$keyword%'";
                    }else{
